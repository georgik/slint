...
// M5Stack Tab5 specific ILI9881C initialization data
// Copied from M5Tab5-UserDemo BSP
// Note: Simplified to avoid DBI read operations that cause hangs
static const ili9881c_lcd_init_cmd_t tab5_lcd_ili9881c_specific_init_code_default[] = {
    ...
    {0xCD, (uint8_t[]){0x14}, 1, 0},
    {0xCE, (uint8_t[]){0x49}, 1, 0},
    {0xCF, (uint8_t[]){0x1F}, 1, 0},
    {0xD0, (uint8_t[]){0x29}, 1, 0},
    {0xD1, (uint8_t[]){0x49}, 1, 0},
